...
public class ExamPane extends BorderPane {
    ...
    private  void dispaly() {
    	...
    	Label l1 = new Label("Set exam time in minutes: ") ;
    	...
    	//Needed to set time up to 12 minutes
    	Spinner minSp = new Spinner(1, 120, 1);
    	...
    	hb.getChildren().addAll(l1 , minSp);
    	...
    	saveB.setOnAction(e->{
    		...
    		if(this.isSavedQues(questions)==false) {
        		...
        		if(result.get() == ButtonType.OK) {
        			try {
        				this.exam.setTime((Integer) minSp.getValue());
            			this.saveExam() ;
